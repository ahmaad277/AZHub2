...
export const dictionary: Record<string, { en: string; ar: string }> = {
  ...
  "metric.activeAnnualYield": { en: "Active Annual Yield", ar: "العائد السنوي النشط" },
  "metric.historicalAnnualYield": { en: "Historical Annual Yield", ar: "العائد السنوي التاريخي" },
