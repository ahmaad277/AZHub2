...
export function AppSidebar({ mobile = false, onNavigate }: AppSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        mobile
          ? "flex h-full w-60 shrink-0 flex-col border-e border-border/40 bg-card shadow-lg"
          : "sticky top-0 hidden h-screen w-60 shrink-0 border-e border-border/40 bg-card/50 backdrop-blur md:flex md:flex-col",
      )}
    >
      <div className="flex items-center gap-2 p-5">
        ...
        <div className="leading-tight">
          ...
          <div className="text-xs text-muted-foreground">v2.6</div>
        </div>
      </div>
